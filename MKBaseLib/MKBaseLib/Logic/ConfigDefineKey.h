...
#ifndef CZBaseFramework_ConfigDefineKey_h
#define CZBaseFramework_ConfigDefineKey_h
...
#define kCZWiFiCallBackOnOff     @"kCZWiFiCallBackOnOff"   //wifi下回拨设置开关
#define kCZ3G4GCallBackOnOff     @"kCZ3G4GCallBackOnOff"   //3g,4g下回拨设置开关
