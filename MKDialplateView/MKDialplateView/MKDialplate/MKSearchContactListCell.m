...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        // 电话或者名字拼音
        self.phoneNumberLab = [[[FontLabel alloc] initWithFrame:CGRectMake(140, 11, [UIScreen mainScreen].bounds.size.width-50-140, 32)] autorelease];
        [self.phoneNumberLab setLineBreakMode:NSLineBreakByTruncatingTail];
        self.phoneNumberLab.textAlignment = NSTextAlignmentRight;
